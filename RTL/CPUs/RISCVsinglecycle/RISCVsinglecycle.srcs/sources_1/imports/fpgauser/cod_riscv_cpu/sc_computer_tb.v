...
module sc_computer_tb;
    ...
    wire [31:0] instr_spy = sc_computer_tb.sc_computer.inst; // spying on the instruction
    wire [31:0] pc4_spy   = sc_computer_tb.sc_computer.pc; // spying on the PC
    ...
    initial begin
        IO_Switch = 16'haaaa;
        forever 
            #10000 IO_Switch = ~IO_Switch; // Toggle switch state every 10ms
    end 
