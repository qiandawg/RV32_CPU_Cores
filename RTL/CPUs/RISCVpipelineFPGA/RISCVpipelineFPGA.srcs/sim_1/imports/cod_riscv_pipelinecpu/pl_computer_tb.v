...
module pl_computer_tb;;
    ...
    wire [31:0] instr_spy = pl_computer_tb.pl_computer.inst; // spying on the instruction
    wire [31:0] pc4_spy   = pl_computer_tb.pl_computer.pc; // spying on the PC
