...
module pipelinedcpu_tb;
    ...
    always @* begin
        ...
        case (instr_spy[6:0])
            ...
            7'b1010011: begin
                case (instr_spy[14:12])
                    3'b000: begin opcode = "FADD.S "; desc = "rd = rs1 + rs2 (FP single precision)"; end
                    3'b001: begin opcode = "FSUB.S "; desc = "rd = rs1 - rs2 (FP single precision)"; end
                    3'b010: begin opcode = "FMUL.S "; desc = "rd = rs1 * rs2 (FP single precision)"; end
                    3'b011: begin opcode = "FDIV.S "; desc = "rd = rs1 / rs2 (FP single precision)"; end
                    3'b100: begin opcode = "FSQRT.S"; desc = "rd = sqrt(rs1) (FP single precision)"; end
                    default: begin opcode = "N/A   "; desc = "undefined F-type op"; end
                endcase
            end
