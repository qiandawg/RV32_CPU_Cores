...
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports {JC[6]}];
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports {JC[5]}];
set_property -dict { PACKAGE_PIN W17   IOSTANDARD LVCMOS33 } [get_ports {JC[3]}];
