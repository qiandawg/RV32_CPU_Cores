...
set_property -dict { PACKAGE_PIN E7    IOSTANDARD LVCMOS33 } [get_ports { JC[5] }]; #IO_L6P_T0_35 Sch=jc[7]
set_property -dict { PACKAGE_PIN E7    IOSTANDARD LVCMOS33 } [get_ports { JC[6] }]; #IO_L6P_T0_35 Sch=jc[7]
