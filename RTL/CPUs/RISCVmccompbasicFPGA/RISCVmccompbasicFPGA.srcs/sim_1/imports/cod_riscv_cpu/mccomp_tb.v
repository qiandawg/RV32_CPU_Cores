...
module mccomp_tb;
    ...
    wire [31:0] instr_spy = mccomp_tb.mccomp_sys.ir; // spying on the instruction
    wire [31:0] pc4_spy   = mccomp_tb.mccomp_sys.pc; // spying on the PC
    ...
    always @* begin
        ...
        case (instr_spy[6:0])
            ...
            7'b0000011: begin // LOAD (Including FLW)
                case (instr_spy[14:12])
            ...
            7'b0100011: begin // STORE (Including FSW)
                case (instr_spy[14:12])
            ...
            7'b0110111: begin // LUI
                  case (instr_spy[14:12])
                    ...
                    3'b000: begin opcode = "LUI  "; desc = "rd = imm"; end // Set immediate value without shifting, just loading upper bits
                 endcase
            end
                           


            7'b0000111: begin // LUI
                 case (instr_spy[14:12])
                    3'b010: begin opcode = "FLW  "; desc = "*(float*)(offset + rs1) = rs2"; end
                 endcase
            end
