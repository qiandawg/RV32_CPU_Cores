...
#
# Script generated by Vivado on Thu Jun 19 23:20:10 -0500 2025
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/JHU_Classes/RISC_V/riscv-cpu/RTL/CPUs/RISCVrv32IM/RISCVrv32IM.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
