...
#set_false_path -to [get_pins sc_computer/cpu/rv32MD/mul_div/SDivide/active]
...
set_clock_groups -asynchronous -group [get_clocks clk_out1_clk_wiz_0] -group [get_clocks clk_out1_clk_wiz_0_1]
...
set_input_delay -clock clk_virt -min -add_delay 0.000 [get_ports {JA[1]}]
set_input_delay -clock clk_virt -max -add_delay 20.000 [get_ports {JA[1]}]
set_input_delay -clock clk_virt -min -add_delay 0.000 [get_ports {JA[4]}]
set_input_delay -clock clk_virt -max -add_delay 20.000 [get_ports {JA[4]}]
#set_input_delay -clock clk_virt -min -add_delay 0.000 [get_ports {JC[4]}]
#set_input_delay -clock clk_virt -max -add_delay 20.000 [get_ports {JC[4]}]
...
set_false_path -to [get_ports JA[1]]
set_false_path -to [get_ports JA[4]]
set_false_path -to [get_ports JC[4]]
