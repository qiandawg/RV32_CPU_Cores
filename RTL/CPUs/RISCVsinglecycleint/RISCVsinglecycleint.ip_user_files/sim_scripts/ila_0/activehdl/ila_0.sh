...
#
# Script generated by Vivado on Sat Aug 02 00:49:43 -0500 2025
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/JHU_Classes/RISC_V/riscv-cpu/RTL/CPUs/RISCVsinglecycleint/RISCVsinglecycleint.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
